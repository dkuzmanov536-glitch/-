...
JWT-то се пази **само в React state** (не в localStorage) — при затваряне/презареждане се излиза
и се въвежда парола наново. Формата за вход е с изключен `autocomplete`, за да не попълва браузърът.
